...
add(checks, "content_audit_decision_fallback", "e2e", control, ["decision_row_from_content_issue", "content_audit_inferred", "content_audit_decision:"], ok_msg="Content-Audit-Faelle ohne decision_class werden semantisch inferiert", bad_msg="Content-Audit-decision_class-Fallback fehlt")
add(checks, "content_audit_decision_fallback_fixture", "e2e", e2e_fixture_script, ["content_fallback_metric_needs_source", "content_fallback_metric_watch", "content_decision_rule_effect"], ok_msg="Content-Audit-decision_class-Fallback ist per E2E-Fixture abgesichert", bad_msg="Content-Audit-decision_class-Fallback-Fixture fehlt")
