...
try {
    ...
    $systemMessage = $syncErrors > 0 ? $syncErrors . ' Datenquellen konnten nicht synchronisiert werden. Andere Bereiche bleiben verfügbar.' : $processHealth['message'];
    ...
    be_json_response(500, ['status' => 'error', 'message' => 'Die Steuerzentrale konnte nicht initialisiert werden.']);
}
