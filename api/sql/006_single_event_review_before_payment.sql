-- === BEGIN FILE: api/sql/006_single_event_review_before_payment.sql | Zweck: ergänzt den Einzelevent-Flow um interne Zahlungsfreigabe mit Token vor Stripe-Checkout; Umfang: einmalige Datenbankmigration ===
...
-- === END FILE: api/sql/006_single_event_review_before_payment.sql ===
