...
import { configureReviewRenderer, renderReview } from './review-render.js?v=2026-08-27-startpartner-premium-finish-v1';
import { configureReviewActions, handleReviewAction } from './review-actions.js?v=2026-07-16-exception-review-v1';
import { handleStartpartnerAction } from './startpartner-review.js?v=2026-08-27-startpartner-premium-finish-v1';
