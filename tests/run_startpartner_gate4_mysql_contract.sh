...
run_engine(){
  ...
  for contract in tests/startpartner_gate4_schema_contract_test.php tests/startpartner_gate4_mysql_contract_test.php tests/startpartner_gate4_v2_journey_contract_test.php; do printf '[%s] Running %s\n' "$engine" "$contract"; STARTPARTNER_TEST_DSN="mysql:host=127.0.0.1;port=${port};dbname=be_contract;charset=utf8mb4" STARTPARTNER_TEST_USER=root STARTPARTNER_TEST_PASSWORD=contract-root php "$contract"; done
