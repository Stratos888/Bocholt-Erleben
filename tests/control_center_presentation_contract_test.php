...
$securityCacheKey='2026-07-21-browser-secret-v1';
$presentationCacheKey='2026-07-17-review-presentation-v1';
assert_contains_text($html,'control-center.js?v=' . $securityCacheKey,'Top-Level-Cachekey muss den Security-Build laden');
assert_contains_text($loader,'control-center/app.js?v=' . $securityCacheKey,'Loader muss den aktuellen Security-App-Build laden');
assert_contains_text($app,'review.js?v=' . $presentationCacheKey,'App muss das aktuelle Review-Modul laden');
assert_contains_text($reviewModule,'review-render.js?v=' . $presentationCacheKey,'Review-Modul muss den aktuellen Renderer laden');
