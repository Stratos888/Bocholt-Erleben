...
// #276-Leitplanke: Der freigegebene Live-Funnel bleibt Referenz.
// Startpartner wird nur als eigener begrenzter Sonderweg additiv eingeordnet.
...
// Event-Funnel: reguläre Live-Wege bleiben, danach eigener Startpartner-Pilot, danach Tippkanal.
...
assert(eventPublish.includes('Startpartner-Pilot – 6 Monate kostenlos testen'), 'Event-Funnel: eigener Startpartner-Sonderweg fehlt');
...
// Aktivitäts-Funnel: Live-Reihenfolge bleibt; Pilot wird zwischen Tarifen und Tippkanal ergänzt.
for (const marker of [
...
assert(activityPublish.includes('Startpartner-Pilot – 6 Monate kostenlos testen'), 'Aktivitäts-Funnel: eigener Startpartner-Sonderweg fehlt');
...
// Erklärseite: reguläre Wege bleiben zusammen; Startpartner steht als eigener Sonderweg danach.
...
console.log('Startpartner special-path live-parity contract: OK');