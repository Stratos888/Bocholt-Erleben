...
$plan = be_cc_validate_event_update($index, $row, [
    'title'=>'Neuer Titel','date'=>'2026-08-02','location'=>'TextilWerk','kategorie'=>'Musik & Bühne','source_url'=>'https://example.org/neu',
]);
...
$activity = be_cc_normalize_activity_updates([
    'title'=>'Aasee erleben','description'=>'Aktualisiert','url'=>'https://www.bocholt.de/aasee','unsupported'=>'ignorieren',
]);
...
$baseline = be_cc_development_assessment([
    'missing_description'=>0,'missing_source'=>0,'missing_date'=>0,'open_quality_reviews'=>0,
...
$attention = be_cc_development_assessment([
    'missing_description'=>2,'missing_source'=>1,'missing_date'=>0,'open_quality_reviews'=>3,
